...
import { IndexHadoopModel } from './index-hadoop.model';
...
@Component({
  selector: 'app-index-hadoop',
  styleUrls: ['./../../assets/styles/theme.scss', './index-hadoop.component.scss'],
  templateUrl: './index-hadoop.component.html',
  providers: [IndexHadoopModel]
})
export class IndexHadoopComponent implements OnInit, OnDestroy, AfterViewInit {
  constructor(
    public domSanitizer: DomSanitizer,
    private common: CommonService,
    private indexModel: IndexHadoopModel,
  ...
  getMenuData() {
    if (localStorage.getItem('menuListMap') !== null) { // 获取缓存里的菜单
      ...
      this.treeNode.dataFormat(menuListMap, 'hadoop'); // 先格式化数据
